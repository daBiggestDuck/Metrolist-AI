...
object SpotifyTokenStore {
    private const val PREFS_NAME = "spotify_token"
    ...
    fun init(context: Context) {
        ...
        synchronized(this) {
            ...
            try {
                ...
                Timber.e(e, "SpotifyTokenStore init failed")
    ...
    private fun encrypt(value: String?): String? {
        ...
        return try {
            ...
            Timber.e(e, "SpotifyTokenStore: encrypt failed")
            null
        }
    }
    ...
    private fun decrypt(value: String?): String? {
        ...
        return try {
            ...
            Timber.e(e, "SpotifyTokenStore: decrypt failed")
            null
        }
    }
    ...
    fun isExpired(skewSec: Long = 60L): Boolean {
        val expiresAt = getExpiresAt()
        if (expiresAt <= 0L) return false
        return (System.currentTimeMillis() / 1000L) >= (expiresAt - skewSec)
    }
    ...
    internal object AesKeystore {
        ...
        private const val KEY_ALIAS = "metrolist_spotify_token_key"
