...
object SettingsSearchCatalog {
    val entries: List<SettingsSearchEntry> =
        listOf(
            ...
            entry("mini_player_settings_title", R.string.mini_player_settings_title, "settings/mini_player", listOf("mini", "now playing", "buttons", "bar")),
            entry("mini_player_like_dislike_swipe", R.string.mini_player_like_dislike_swipe, "settings/mini_player", listOf("like", "dislike", "swipe", "heart", "thumb")),
            entry("mini_player_show_dj_button", R.string.mini_player_show_dj_button, "settings/mini_player", listOf("metro dj", "hide", "button")),
            entry("nano_dj_hold_to_voice", R.string.nano_dj_hold_to_voice, "settings/mini_player", listOf("hold", "voice", "talk", "dj", "speak")),
